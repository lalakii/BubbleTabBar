...
[![](https://img.shields.io/badge/API-26%2B-orange.svg?style=flat-square)](https://android-arsenal.com/api?level=26)
...
[![Maven Central](https://img.shields.io/maven-central/v/cn.lalaki/bubbletabbar.svg?label=Maven%20Central&logo=sonatype)](https://central.sonatype.com/artifact/cn.lalaki/bubbletabbar/)
...
```gradle
    implementation  'cn.lalaki:bubbletabbar:1.0.0'
```
