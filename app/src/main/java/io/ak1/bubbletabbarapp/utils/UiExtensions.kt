 ...
 */
fun SharedPreferences?.setupTheme(
    key: String?,
    resources: Resources,
) {
...
fun Context.getColors(): IntArray {
    return intArrayOf(
        ContextCompat.getColor(this, io.ak1.bubbletabbar.R.color.home),
        ContextCompat.getColor(this, io.ak1.bubbletabbar.R.color.logger),
        ContextCompat.getColor(this, io.ak1.bubbletabbar.R.color.documents),
        ContextCompat.getColor(this, io.ak1.bubbletabbar.R.color.settings),
        ContextCompat.getColor(this, io.ak1.bubbletabbar.R.color.home),
    )
}
