        ...
        fun bind() {
            ...
            fragmentChildBinding.root.setBackgroundColor(
                ContextCompat.getColor(
                    fragmentChildBinding.root.context,
                    when (adapterPosition) {
                        0 -> io.ak1.bubbletabbar.R.color.home
                        1 -> io.ak1.bubbletabbar.R.color.logger
                        2 -> io.ak1.bubbletabbar.R.color.documents
                        else -> io.ak1.bubbletabbar.R.color.settings
                    },
                ),
            )
        }
